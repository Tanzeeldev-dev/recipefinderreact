...
const styles = StyleSheet.create({
  ...
  dayTitle: { fontSize: 16, fontFamily: "Inter_700Bold", marginTop: 4 },
  slotCard: { borderRadius: 16, borderWidth: 1, padding: 14, gap: 10 },
  slotHeader: { flexDirection: "row", alignItems: "center", gap: 6 },
  slotLabel: { fontSize: 12, fontFamily: "Inter_600SemiBold", textTransform: "uppercase", letterSpacing: 0.5 },
  slotRecipe: { flexDirection: "row", alignItems: "center", gap: 10 },
  slotRecipeContent: { flex: 1, gap: 4 },
  slotRecipeTitle: { fontSize: 15, fontFamily: "Inter_700Bold", lineHeight: 20 },
  slotMeta: { flexDirection: "row", alignItems: "center", gap: 6 },
  slotMetaText: { fontSize: 12, fontFamily: "Inter_400Regular" },
  ...
  addSlotText: { fontSize: 14, fontFamily: "Inter_600SemiBold" },
});
