      ...
      <View style={styles.section}>
        ...
        <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <View style={styles.field}>
            ...
            <View style={[styles.inputWrap, styles.textAreaWrap, { backgroundColor: colors.muted, borderColor: colors.border }]}>
              <TextInput
                style={[styles.input, { color: colors.foreground }, webInput]}
                value={bio}
                onChangeText={setBio}
      ...
      <View style={styles.section}>
        ...
        <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
          {[
            ...
            <View
              key={item.label}
              style={[styles.aboutRow, { borderBottomColor: colors.border, borderBottomWidth: i < arr.length - 1 ? StyleSheet.hairlineWidth : 0 }]}
            >
