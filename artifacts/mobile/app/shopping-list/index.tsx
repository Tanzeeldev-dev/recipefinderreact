...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 14, fontFamily: "Figtree_400Regular", marginBottom: 4 },
  ...
  addInput: { flex: 1, fontSize: 15, fontFamily: "Figtree_400Regular", paddingVertical: 8 },
  addBtn: { width: 36, height: 36, borderRadius: 10, alignItems: "center", justifyContent: "center" },
  sectionLabel: { fontSize: 11, fontFamily: "Figtree_600SemiBold", letterSpacing: 0.8 },
  ...
  itemName: { fontSize: 15, fontFamily: "Figtree_500Medium", lineHeight: 20 },
  itemRecipe: { fontSize: 11, fontFamily: "Figtree_400Regular" },
